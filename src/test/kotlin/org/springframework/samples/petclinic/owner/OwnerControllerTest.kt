...
class OwnerControllerTest {
        ...
        @MockBean private lateinit var owners: OwnerRepository

        @MockBean private lateinit var visits: VisitRepository
        ...
        fun setup() {
                ...
                given(visits.findByPetId(max.id!!)).willReturn(Collections.singleton(visit))
        }
        ...
        fun testProcessFindFormSuccess() {
                given(owners.findByLastName(""))
                                .willReturn(Lists.newArrayList<Owner>(george, Owner()))
        ...
        fun testProcessFindFormByLastName() {
                given(owners.findByLastName(george.lastName))
                                .willReturn(Lists.newArrayList<Owner>(george))
